...
import static setup.PropertyFile.MOBILEFARM;

public class TestProperties {
    Properties currentProps = new Properties();

    Properties getCurrentProps() throws IOException {
        FileInputStream in = new FileInputStream(System.getProperty("user.dir") + MOBILEFARM.prop); //NATIVE.prop or WEB.prop for native or web test
